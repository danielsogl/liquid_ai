...
class ConversationManager(
    ...
    fun createConversation(
        ...
        val runner =
            runnerManager.getRunner(runnerId)
    ...
    fun generateResponse(
        ...
        val sdkMessage =
            parseFlutterMessageToSdk(message)
        ...
        val job =
            scope.launch {
                try {
                    ...
                    state.conversation
                        .generateResponse(sdkMessage, generationOptions)
                        .onEach { response ->
                            ...
                            when (response) {
                                ...
                                is MessageResponse.FunctionCalls -> {
                                    val serializedCalls =
                                        response.functionCalls.mapIndexed { index, call ->
                                            mapOf(
                                                "id" to "call_$index",
                                                "name" to call.name,
    ...
    fun registerFunction(
        ...
        val parameters =
            function["parameters"] as? Map<String, Any>
    ...
    private fun parseParameterType(
        ...
        return when (typeString) {
            "string" -> {
                LeapFunctionParameterType.LeapStr(enumValues = enumValues)
            }

            "number" -> {
                LeapFunctionParameterType.LeapNum()
            }

            "integer" -> {
                LeapFunctionParameterType.LeapInt()
            }

            "boolean" -> {
                LeapFunctionParameterType.LeapBool()
            }
            ...
            "array" -> {
                ...
                if (itemsSchema != null && itemType != null) {
            ...
            "object" -> {
                ...
                if (nestedProps != null) {
                    val properties =
                        nestedProps
                            .mapNotNull { (propName, propSchema) ->
